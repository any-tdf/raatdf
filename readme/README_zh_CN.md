...
RAATDF 是一个高效、优雅、轻量级的企业级后台管理模板，采用最新技术栈构建，提供开箱即用的解决方案。
...
- **浮动 UI**: 优雅的浮动 UI 风格
- **沉浸模式**: 专注内容的全屏体验
- **侧栏工具**: 将工具栏放置在侧边栏底部（仅垂直布局）

## 主题系统

- **明暗主题**: 亮色、暗色、跟随系统三种模式
- **主题色**: 10+ 预设颜色 + 自定义颜色
- **动态切换**: 通过 CSS 变量实现无缝主题切换
- **圆角大小**: 9 种圆角尺寸可选（0-24px）

## 交互增强

- **多标签页**: 最多 16 个标签页，自动关闭最早标签
- **页面缓存**: 保留页面状态，提升用户体验
- **标签风格**: 默认、按钮、简洁、堆叠四种风格
- **过渡动画**: 滑动、淡入、缩放等多种动画效果
- **紧凑模式**: 适合数据密集型场景
...
请遵循 [约定式提交](https://www.conventionalcommits.org/zh-hans/)：
...
- 💬 [GitHub Issues](https://github.com/any-tdf/raatdf/issues) - 错误报告和功能请求
- 🔀 [GitHub Discussions](https://github.com/any-tdf/raatdf/discussions) - 讨论和问答
...
<a href="https://github.com/any-tdf/raatdf/graphs/contributors">
  <img src="https://contrib.nn.ci/api?repo=any-tdf/raatdf" alt="贡献者" />
</a>

# 赞助商

如果本项目对您有帮助，请考虑赞助以支持我们的持续开发。

<!-- 赞助商列表 -->

# 开源协议

本项目基于 [MIT](https://github.com/any-tdf/raatdf/blob/main/LICENSE) 协议开源。
